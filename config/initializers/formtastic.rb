class DatePickerInput < Formtastic::Inputs::StringInput
  def input_html_options
    { 
      :value => object.send(method).try(:strftime, '%d/%m/%Y'),
      :class => 'date'
    }.merge(super)
  end
end

class ComboInput < Formtastic::Inputs::SelectInput
  def input_html_options
    { 
      "data-combo" => true
    }.merge(super)
...
class TypeAheadInput < Formtastic::Inputs::StringInput
  def input_html_options
    { 
      :value => object.send(((method.to_s)).to_sym),
      "data-typeahead" => url,
...
class StaticTypeAheadInput < Formtastic::Inputs::StringInput
  def input_html_options
    { 
...
# Formtastic::FormBuilder.custom_inline_order[:string] = [:errors, :input, :hints]
